...
namespace Acme.Biz.Tests
{
    ...
    public class VendorRepositoryTests
    {
        ...
        public void RetrieveValueObjectTest()
        {
            ...
            //var actual = repository.RetrieveV
        }
        ...
        [TestMethod()]
        public void RetreieveValueTest()
        {
            // Arrange
            var repository = new VendorRepository();
            var expected = 42;
            ...
            // Act
            var actual = repository.RetreieveValue<int>("Select ...", 42);
        ...
        [TestMethod()]
        public void RetreieveValueStringTest()
        {
            // Arrange
            var repository = new VendorRepository();
            var expected = "test";
            ...
            // Act
            var actual = repository.RetreieveValue("Select ...", "test");
